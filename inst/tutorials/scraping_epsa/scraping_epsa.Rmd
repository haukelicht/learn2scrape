...
Here, we just need to adapt the function we wrote then. If you skipped the tutorial but feel equipped to proceed right away, just try to think about how to write a function that scrapes text and apply it to the URLs we collected.
...
```{r scrapeabstracts,exercise=TRUE}
paper_links<-titlepage %>% html_nodes("a[href^='/stages']") %>% html_attr("href")
```
