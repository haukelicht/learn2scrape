...
Of course, you can also use [regular expressions](https://stringr.tidyverse.org/articles/regular-expressions.html){target="_blank"} if you already know them, however, there is no need to learn them just for our dictionary.
