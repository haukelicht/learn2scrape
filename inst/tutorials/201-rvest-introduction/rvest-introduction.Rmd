...
```{r echo = FALSE, exercise = FALSE, fig.cap="*Fig 2* --- R documentation of `html_elements()`"}
...
```{r nodes, exercise.setup="page-setup"}
...
```{r textnodes,  exercise.setup='page-setup'}
